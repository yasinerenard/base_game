import pygame,sys,os,pytmx,math
...
def fromsamefolderget(file):
    script_dir = os.path.dirname(os.path.abspath(__file__))
    return f"{script_dir}/{file}"

#tmxmap = load_pygame(fromsamefolderget("basic.tmx"))
...
def move_pyobject(obj, keys, speed=100):
